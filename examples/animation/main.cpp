...
int main(int argc, char* argv[])
{
    ...
    VART::Transform greenSphereTranslation;
    ...
    greenSphereTranslation.MakeTranslation(1, 0, 0);
    ...
    greenSphereTranslation.AddChild(greenSphere);
    greenSphereRotation.AddChild(greenSphereTranslation);
